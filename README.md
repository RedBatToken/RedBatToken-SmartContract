...
Red Bat Token's SmartContract
                ...
                */
                ...
                // (c) by Mat Jargon 2021. 

                // RED BAT TOKEN
                // TELEGRAM: @REDBATTOKEN
                ...
                contract REDBAT is Context, IERC20, Ownable {
                    ...
                    uint256 private minimumTokensBeforeSwap = 75000 * 10**18; 

                    address payable private charityAddress = 0xDD42DD1ef3cBcf2eaD2FeEB3293e4ceD7302Ded7; //BAT PRODUCTION DEVELOPMENT AND MARKETING
                    ...
                    function totalDonationBNB() private view returns (uint256) {
                        // BNB has  18 decimals!
                    ...
                    function BATBATBAT() external onlyOwner() {
                       _taxFee = 0;
                        _burnFee = 0;
                        _donationFee = 8;
                    }
